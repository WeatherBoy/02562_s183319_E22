...
float3 Glossy::shade(const Ray& r, HitInfo& hit, bool emit) const {
	...
	/*
	* This was for having no reflection, refraction whatsoever
	* 
	...
	*/
	...
	return Phong::shade(r, hit, emit) + R * shade_new_ray(reflected, hit_reflected) + (1.0f - R) * shade_new_ray(refracted, hit_refracted);
